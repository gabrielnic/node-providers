...
const SNSES: &[(&str, &str)] = &[
    ("Alice", "9261d1ea5c1afe890603e74af26befad8aa2d81345d6ca78165fb5277efe816a"),
    ("Boom DAO", "38af024c2f3a8681e661b67065e5d83d692d16252a7cdd96bae94452b65f498d"),
    ("Catalyze", "80fe79cb19aca870c65fafca8d245d183b226d1847cf901c66dadcc754a0db04"),
    ("Cycles Transfer Station", "97c0700e13d8fc2d2618f16a0b93e19951a5c4d35d367ec9814149c95953681b"),
    ("DecideAI DAO", "e15c74c8857e24fb70287f9b200ce00194ba77ee8b3c97b684988ab14e219f9e"),
    ("DOGMI", "628f27a0a27da37691d1eebe7d521d1a8a91758759cc55b5d1ffd2924a9cd396"),
    ("DOLR AI", "a512e418044d132fa67305bb8fad227361b65241e0b47804551b5ad1a21b5e41"),
    ("Dragginz", "7765cb3b0431c7043e400e1953d3ed683bf206dfd07f166db5cd5d76089a11e7"),
    ("ELNA AI", "f9e460888e2a5fbb25257050f4f01ecad02db6e50ab73b21f7ca4dfa13e7df3d"),
    ("EstateDAO", "7bdf8bede107f3162851a7f991b0eb136c7427c4ebbe52cdc734439fd897087c"),
    ("FomoWell", "ecbb2de23975500b7f0e4eea75def708288716b1765d30a7c31774b3c31d6284"),
    ("FuelEV", "dbe4b1c84bb41452707c9946c2ddd88550239631c075d880e3cdae5e4d48bd96"),
    ("Gold DAO", "904258703bed6394339480ab800463377bbc3f0c3d4d318cdbf041e1d523f6cf"),
    ("IC Explorer", "fe4d787520a9b7fddf417d93860ae61f712edaccefc81d74d6a7ca503932e0df"),
    ("ICFC", "027e0f12568c596ff22fbb6225a3bf27592792db144eb674267431fcdb7c46fe"),
    ("ICGhost", "b504c213ee07de6612862248d20efc8f2f42fa79161a5c5199ed4414e362ce5d"),
    ("ICLighthouse DAO", "c13e11c0768ad2ecaefc18a70e0d7bff5c4bc71cc1b5a5885d24bca19e8ecc78"),
    ("ICPanda", "25e39e3c97dce634ada733b1cc25791fb7f87e718972ed489dc9303810397529"),
    ("ICPCC DAO LLC", "e92beab62f0d599beff629f3ea353a04ebce43e354f13fc5cbe221088ed4ee51"),
    ("ICPSwap", "c09c7985ac5f6d5317b4ad6a9c6e148c3fbe29e0c64d467c2185afcd8a710639"),
    ("ICVC", "3dd8e10a849b6e21908de560ec27d91322455a08061eb6a0f57a5c21cf841035"),
    ("Kinic", "ab693284da4315917861904bab06840fb96ee813f174e7cf7dc25475b2285edb"),
    ("KongSwap", "f39d9b22c382c25f832fd1d3e6ad5216249623b204a7fc5498f991f4cf2df1e1"),
    ("Motoko", "6f42eb919c18b05a79904bf7214bfce9d1cd365ea3bfcb51012098fe996fab59"),
    ("Neutrinite", "e6c824c84552a15262d45f3648e59053ebab6cec9685ab71fd6ef20976769d7e"),
    ("NFID Wallet", "3cf1d9fb545642f81614c45a6d9d42586edff3820b4443af5efd3828dce60741"),
    ("Nuance", "f77cc353c778b02ad26974891950e4cb3ae1203e5cd8218e1b99bfc4f316d897"),
    ("OpenChat", "a2200978cf15fa0d19b7c7eb75cc5d6d3ebabbacaec64a2a9a3f811277619c57"),
    ("ORIGYN", "ab0015f10e8e90230e3a6659eb9ec7df3df1c75a5b8a74d18ac64c8676eeb1ff"),
    ("Personal DAO", "ac848b7d6f8500be4264c88171f1e9a169147b2c5a8b521478dc8bc8e0c37764"),
    ("Seers", "15d2a4b086f1420f4876ad90049d159eaf1f05edae26e8f1389dc28f14a3c904"),
    ("Sneed", "580deb37eb3583e5854516481bd52c2618ca73ef6ee1c2df2b556bf85c0ce5a9"),
    ("SONIC", "73ad3f017d0d01544af6c6ba1b28976c91295d3bd5d7c6fe28094c2b95c85105"),
    ("TRAX", "a1da3161ab8bc73b2d4496175acb6dc742e1bac278fd2dce0034802f5ec74a21"),
    ("WaterNeuron", "74aaf573c3dcfedb688dafaf52cc71c0514f9e9178989e795c253d30e37d65f6"),
    ("Yuku AI", "3eddf794a9e64025238ef1a3c2e6bbf0bfd5a6e0dfa7cabef9e676921eabdafe"),
];
...
fn get_entries() -> Vec<Account> {
    ...
    // no name
    entries.extend(FOUNDATION.iter().map(|addr| Account::new(&addr[..5], addr, Type::Exchange)));
    entries.extend(SPAMMERS.iter().map(|addr| Account::new(&addr[..5], addr, Type::Sns)));
